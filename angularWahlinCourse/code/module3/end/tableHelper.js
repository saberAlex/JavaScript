  ...
  var tableHelper = function() {
      var template = '<div class="tableHelper"></div>',
          ...
          link = function(scope, element, attrs) {
              var headerCols = [], //this is the actual column name
                  tableStart = '<table>',
                  tableEnd = '</table>',
                  table = '',
                  visibleProps = [],
                  sortCol = null,
                  sortDir = 1;
          //this is to know if the datasource changed. this is watch the data collection.
          ...
          function wireEvents() {
            //we are gonna take what's cliked (any TH table header is click)
          ...
          function sort(col) {
              ...
              sortCol = col;
              //this is the sort for javascript (this is the standard javascript)
