(function() {
  ...
  //parse will convert the string into an object.
  var tableHelperWithParse = ['$parse', function ($parse) {
      ...
      link = function(scope, element, attrs) {
          ...
          //columnmap = scope.$eval(attrs.columnmap); //this will automatically convert the coloumnmap attribute into an object
          columnmap = $parse(attrs.columnmap)(); //when use parse we need to invoke the function
          wireEvents();
