(function() {
  ...
  var tableHelperWithNgModel = function () {
      ...
      //we just short the ngModel from ngModelController
...
//             return ngModel.$modelValue; //this is what we specificly want to watch for.
//          }, function(newValue) {
//              render();
//          });

            //when either $modelValue and $viewValue change, we do something
...
//          };
          ...
          function render() {
              if (ngModel && ngModel.$modelValue.length) { //make sure that the model has value and not zero.
                //assign ngModel.$modelValue to datasource.
      ...
      return {
          restrict: 'E',
          require: 'ngModel', //ngModel will be imported to our directives at the run time. give ^?ngModel
          scope: {
            columnmap: '='
          },
          link: link,
